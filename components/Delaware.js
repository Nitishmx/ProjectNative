  ...
  return (
    <View>
      ...
      <View style={{flexDirection:"row",justifyContent:"space-between",marginHorizontal:14, marginTop:20}}>
         ...
         <Text style={{color:"blue",fontWeight:600}} onPress={()=>navi.navigate("Dining Halls")}>View all</Text>
      </View>
     ...
     horizontal={true}
        ...
        <Text style={{marginLeft:10,marginTop:4}} onPress={()=>navi.navigate("Details")}>{item.title}</Text>
     ...
     horizontal={true}
        ...
        <Text style={{marginLeft:10,marginTop:4}} onPress={()=>navi.navigate("Dining Halls")}>Backyard Bowls</Text>
