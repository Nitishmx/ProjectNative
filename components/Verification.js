  ...
  return (
    <View backgroundColor="#009EEB">
     <View style={{height:"100%",width:"84%",margin:"auto",marginTop:80}}>
       ...
       <TouchableHighlight>
         <Text style={{backgroundColor:"white",height:60,borderRadius:4,textAlign:"center",textAlignVertical:"center",fontSize:20,fontWeight:600,marginTop:40}}>Verify</Text>
       </TouchableHighlight>
